...
export const videos: VideoAsset[] = [
  ...
  },
  {
    ...
    creativeFunction: "Product handling & sequencing",
  ...
  },
  {
    ...
    creativeFunction: "Direct-to-camera tutorial",
    rightsStatus: "cleared",
    public: true,
    categories: ["on-camera", "product-demo", "lifestyle"],
    originalLinks: {
  ...
  },
  {
    ...
    creativeFunction: "Unboxing, garment detail & fit reveal",
    rightsStatus: "cleared",
    public: true,
    categories: ["on-camera", "product-demo", "lifestyle"],
  },
  {
    ...
    dimensions: "576 x 1024",
    relationship: "creator-owned portfolio footage",
    creativeFunction: "Quick-change hook & product reveal",
    rightsStatus: "cleared",
    public: true,
    categories: ["on-camera", "product-demo", "lifestyle"],
  },
  {
    ...
    dimensions: "576 x 1024",
    relationship: "creator-owned portfolio footage",
    creativeFunction: "Direct-to-camera beauty",
    rightsStatus: "cleared",
    public: true,
  ...
  },
  {
    ...
    dimensions: "576 x 1024",
    relationship: "creator-owned portfolio footage",
    creativeFunction: "Professional lifestyle / direct-to-camera",
    rightsStatus: "cleared",
    public: true,
    categories: ["on-camera", "lifestyle"],
  },
  ...
  },
  {
    ...
    title: "A slower look at the details.",
    ...
    dimensions: "576 x 1024",
    relationship: "creator-owned portfolio footage",
    creativeFunction: "Extended product unboxing",
    rightsStatus: "cleared",
    public: true,
