  ...
  return (
    <>
      ...
      <main id="main">
        ...
        <section className="contact-section" id="contact" aria-labelledby="contact-title"><p className="eyebrow">Let’s make something clear</p><h2 id="contact-title">Tell me what you need the content to <em>do.</em></h2><p className="contact-intro">Send the product, the customer you need to reach, where the content will run and when you need it. I will respond with my fit for the project, the creative route I recommend and a quote.</p><div className="contact-actions"><a className="contact-link" href={`mailto:${email}?subject=UGC%20brief%20for%20Monisola%20Adejo`}>Send the Brief <span aria-hidden="true">↗</span></a><a className="contact-secondary" href={instagram} target="_blank" rel="noreferrer">Instagram DM <span aria-hidden="true">↗</span></a></div><div className="contact-details"><a href={`mailto:${email}`}><svg className="contact-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d={contactIcons.email} /></svg>{email}</a><a href={instagram} target="_blank" rel="noreferrer"><svg className="contact-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d={contactIcons.instagram} /></svg>@youragilenurse</a><a href={tiktok} target="_blank" rel="noreferrer"><svg className="contact-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d={contactIcons.tiktok} /></svg>@youragilenurse</a></div></section>
      </main>
